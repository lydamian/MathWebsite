...
console.log("subtraction.js page called...");
...
function getResult(form){
	...
	window.location.assign("http://localhost:8080/MathWebsite/subtractionproblems.html?type="+type+"&num_problems="+num_problems);
}